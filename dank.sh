...
function roll(){
        d20=$(($RANDOM%20+1))
        d20=$(($d20+$mod))            #            creates a function for the 20 sided die roll and adds any additional modifiers
}
...
function memelord(){ #                  this function draws the ascii victory banner 
        clear
        toilet -t 'Victory!' | boxes | lolcat;
        toilet All Hail; 
        toilet Meme Lord; 
        toilet $name 
...
function install(){ #                installs packages needed to draw the ascii banner
        ...
        a | A ) clear
                ...
                read ANSWER
                case $ANSWER in
                a | A ) sudo apt update && sudo apt upgrade -y; 
                        sudo apt install toilet -y; 
                        sudo apt install boxes -y; 
                        sudo apt install lolcat -y
                ;;
                b | B ) sudo dnf update && sudo dnf upgrade -y; 
                        sudo dnf install toilet -y; 
                        sudo dnf install boxes -y; 
                        sudo apt install lolcat -y
                ;;
                c | C ) sudo pacman -Syy && sudo pacman -Syu -y;
                        sudo pacman -s toilet -y; 
                        sudo pacman -s boxes -y; 
                        sudo pacman -s lolcat -y 
                ;;
                esac 
        ;;
        b | B ) echo ""
...
function badluckbrian(){ #               Character specific functions for the story
        ...
        a | A ) if (($d20>$memeroll))
                then clear
                        ...
                        echo ""
                        echo ""
                        echo "$name's roll: $d20 Bad Luck Brian's Roll: $memeroll"; echo ""
...
function scumbagsteve(){
        ...
        b | B ) clear
                ...
                echo "" 
                echo "" 
                echo "Instant Defeat! Not a big brain play!"
                echo ""
                echo -e "Scumbag Steve agrees to trade, takes Bad Lunch Brian's 
                        \nlunch money and sucker punches you.
...
function ducreux(){
        ...
        a | A ) clear 
                ...
                echo "" 
                echo "" 
                echo "Instant victory for a big brain play" 
                echo ""
...
function philosoraptor(){
        ...
        b | B ) if (($d20>$memeroll))
                then clear 
                        ...
                        echo "" 
                        echo ""
                        echo "Philosorapter was delighted by the treat he was given, and gives 
                                $name the key to the final chamber."
                        read -p "Press enter to continue --->"
                else clear 
                        gameover 
                        echo "" 
...
function willsmith(){
        ...
        a | A ) if (($d20>$memeroll))
                then clear 
                        ...
                        echo "" 
                        echo ""
                        echo "Will Smith slaps you into next year"
                        exit
                fi
        ;;
        b | B ) clear 
